...
# since these are two diff data structures, there are some common attributes and methods, they may return different results in both cases because of different underlying data.
    ...
    ## Attribute is a piece of data that belongs to the object, it simply stores a data/characteristic about the object, like
    ## method on the other hand is a command or a behaviour that we ask the the object to perform for us.Like Head() method

# essesntially a dataframe object comprises of smaller different objects to make up this big object, like many series objects
...
rev = pd.read_csv('/Users/Rishabh_Tyagi/Box Sync/1_RT_docs/2_My_py_projects/0_Python_RT/01. python_from_scratch/pandas/revenue.csv')
rev
rev.info()

rev = pd.read_csv('/Users/Rishabh_Tyagi/Box Sync/1_RT_docs/2_My_py_projects/0_Python_RT/01. python_from_scratch/pandas/revenue.csv',index_col='Date') # setting one of the column from csv as index
rev
